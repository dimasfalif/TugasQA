<?php
    ...
    class MYPDF extends TCPDF {
        ...
        public function Header() {
            ...
            $html = '<strong><font size="18">PD. Grafika Kreatif Indonesia</font></strong><br/><br/>
           CIPUTAT MUTIARA CENTER BLOK C 19, JL. DEWI SARTIKA 88
            <br/>
                ';
                $this->writeHTMLCell(
                    $w=0,
        ...
        public function Footer() {
            ...
            $tgl = date("d F Y");
            // $this->SetY(-55);
            $html = '<font size="10">Tangerang selatan, '.$tgl.' <br/><br/> <br/><br/>
           '.$_SESSION['nama'].'<font>
            <br/>';
            $this->writeHTMLCell(
                $w=0,
